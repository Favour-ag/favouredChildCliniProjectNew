  ...
  return (
    ...
    <Navbar />
      <div className="container mx-auto py-8 px-1 lg:px-12">
        <h1 className="text-5xl font-bold mb-6 text-left md:text-center mt-[-16px] md:mt-[-20px] ">Contact Us</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          <div className=''>
            <h2 className="text-3xl font-semibold mb-2 ">Contact Information</h2>
            <p className='text-xl'>4 Jerry Avenue New Heaven Extension Opposite </p>
